...
# МІНІМАЛЬНИЙ час довіри щойно надісланій команді (реальний рахується від
# update_rate — див. EVSECoordinator.pending_ttl).
#
...
# "вискакують назад": натиснув -> наступне опитування повернуло старе значення.
